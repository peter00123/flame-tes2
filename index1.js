...
function flames(){
  ...
  if(a!=""&&b!=""){
    ...
    res.innerHTML="<b style='color:red;'>"+document.getElementById("name2").value+"</b> <b style='color:white;'>"+flames+"</b>";
  }else{
...
function verifie(){
  ...
  if(a!=""&&b!=""){
    if((b==n1||b==n2)&&(a=="amruta"||a=="amru")){
      res.innerHTML="<b style='color:green;'>"+document.getElementById("name2").value+"</b> is Your <b style='color:blue;'>Love</b>";
      Lov();
